...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `contact` (`contact_id`, `contact_name`, `contact_email`, `contact_message`) VALUES (NULL,'$contact_name', $contact_email','$contact_message')";
...
<head>
   ...
   <title>Contact OCR</title>
</head>

<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
     Contact Us Form for ORC
   </nav>

   <div class="container">
      <div class="text-center mb-4">
         <h3>Add New Contact</h3>
         <p class="text-muted">Complete the form below to add new contact </p>
      </div>
         ...
         <form action="" method="post" style="width:50vw; min-width:500px;">
            <div class="row mb-3">
               ...
               <div class="col">
                  ...
                  <input type="text" class="form-control" name="contact_message" placeholder="Insert your comment">
               </div>
